...
namespace Soccer.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("2020", "Emilio", "Barrera", "barrera_emilio@yahoo.es", "350 634 2747", "Calle Luna Calle Sol", UserType.User);
            await CheckUserAsync("3030", "Emilio", "Barrera", "emiliobarrerasepulveda@gmail.com", "350 634 2747", "Calle Luna Calle Sol", UserType.User);
